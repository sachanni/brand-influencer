...
export default function InfluencerMessages() {
  ...
  // Filter conversations - exclude campaign-related conversations
  const filteredConversations = conversations
    .filter(conversation => !conversation.campaignId) // Exclude campaign conversations
    .filter(conversation => {
    const matchesSearch = 
      conversation.brand.firstName.toLowerCase().includes(searchQuery.toLowerCase()) ||
      conversation.brand.lastName.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  const handleCreateConversation = () => {
    if (!newConversationData.brandId || !newConversationData.subject) return;
  ...
  // Quick message templates for influencers
  const quickTemplates = [
    { id: 'interested', title: 'Interested', content: "Hi! I'm very interested in this campaign and would love to discuss the details further." },
    { id: 'timeline', title: 'Timeline Question', content: "Hi! Could you please provide more details about the timeline and key milestones for this campaign?" },
    { id: 'creative', title: 'Creative Ideas', content: "Hi! I have some exciting creative ideas for this campaign that I'd love to share with you." },
    { id: 'rates', title: 'Discuss Rates', content: "Hi! I'd like to discuss the compensation structure and delivery timeline for this collaboration." },
  ];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Brand Communications</h1>
            <p className="text-gray-600 dark:text-gray-300 mt-1">Connect with brands and manage collaboration discussions</p>
          </div>
          <Dialog open={showNewConversation} onOpenChange={setShowNewConversation}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Contact a Brand</DialogTitle>
              </DialogHeader>
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    value={newConversationData.brandId}
                    onChange={(e) => setNewConversationData(prev => ({ ...prev, brandId: e.target.value }))}
                ...
                <Button 
                  ...
                  disabled={!newConversationData.brandId || !newConversationData.subject || createConversationMutation.isPending}
                  className="w-full"
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <Card>
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-2xl font-bold text-purple-600">{activeConversations}</p>
              ...
              {selectedConversationData ? (
                  ...
                  <CardHeader className="border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <div className="relative">
                          <div className="w-10 h-10 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full flex items-center justify-center text-white font-medium">
                            {selectedConversationData.brand.firstName[0]}{selectedConversationData.brand.lastName[0]}
                          </div>
                        ...
                        <div>
                          <h3 className="font-semibold text-gray-900 dark:text-white">
                            {selectedConversationData.brand.firstName} {selectedConversationData.brand.lastName}
                          </h3>
                    ...
                    <div className="h-96 overflow-y-auto p-4 space-y-4 bg-gray-50 dark:bg-gray-800/50">
                      {messagesLoading ? (
                        ...
                        messages.map((message) => (
                          <div
                            key={message.id}
                            className={`flex ${message.senderId === selectedConversationData.influencerId ? 'justify-end' : 'justify-start'}`}
                          >
                            <div className="flex items-start space-x-2 max-w-xs">
                              {message.senderId !== selectedConversationData.influencerId && (
                              ...
                              >
                                ...
                                <div className="flex items-center justify-between mt-1">
                                  <p className={`text-xs ${
                                    message.senderId === selectedConversationData.influencerId ? 'text-teal-100' : 'text-gray-500'
                                  }`}>
                ...
                <CardContent className="flex items-center justify-center h-96">
                  <div className="text-center">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mb-4">Select a conversation to connect with brands and discuss collaborations</p>
                    <Button 
