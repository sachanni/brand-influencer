...
import { SearchSection, SearchFilters } from "@/components/sections/search-section";
import { FeaturedInfluencers } from "@/components/sections/featured-influencers";
...
export default function Landing() {
  ...
  const handleSearch = (filters: SearchFilters) => {
    ...
    // Scroll to results
    const featuredSection = document.getElementById('featured-influencers');
    if (featuredSection) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Navigation />
      <HeroSection 
        onJoinAsBrand={() => handleJoinAsRole('brand')}
        onJoinAsInfluencer={() => handleJoinAsRole('influencer')}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              <h3 className="text-2xl font-bold text-white mb-4">Influencer Hub</h3>
              <p className="text-purple-200 mb-6 max-w-md">
                The world's leading platform connecting brands with authentic creators for meaningful partnerships and measurable results.
              </p>
              <div className="flex gap-4">
                <div className="p-3 rounded-2xl bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-colors cursor-pointer">
      ...
      <RegistrationModal
        ...
        onSwitchToLogin={() => setShowRegistrationModal(false)}
